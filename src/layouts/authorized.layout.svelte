<script lang="ts">
    ...
    import CmsPages from "../lib/components/cms/dashboard.svelte";
    import CmsCategories from "../lib/components/cms/page-categories.svelte";
    ...
    let categoriesModalOpen = false,
        ...
        cmsPagesModalOpen = false,
        cmsCategoriesModalOpen = false,
...
<Modal id="cms-modal" title="Pages" size="xl" autoclose={false} bind:open={cmsPagesModalOpen}>
    <CmsPages />
</Modal>

<Modal id="cms-categories-modal" title="CMS Categories" size="xl" autoclose={false} bind:open={cmsCategoriesModalOpen}>
    <CmsCategories />
</Modal>
<div class="relative">
    ...
    {#if showNotifications && showNotifications.length !== 0}
        {#each showNotifications as notification, index (notification.id)}
            <Toast message={notification.message} type={notification.type} position="top-right" show />
        {/each}
    {/if}
        ...
        >
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul class="space-y-2">
                    <li>
                        <a
                                href="#" on:click|preventDefault={() => categoriesModalOpen = !categoriesModalOpen}
                    ...
                    <li>
                        ...
                        <Dropdown triggeredBy="#cmsTrigger">
                            <DropdownItem on:click={() => cmsPagesModalOpen = !cmsPagesModalOpen}>Pages</DropdownItem>
                            <DropdownItem on:click={() => cmsCategoriesModalOpen = !cmsCategoriesModalOpen}>Categories</DropdownItem>
